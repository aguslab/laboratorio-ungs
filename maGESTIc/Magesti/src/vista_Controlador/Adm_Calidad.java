...
public class Adm_Calidad extends JInternalFrame {
	private JTextField txtNombreVariante;

	
	public Adm_Calidad() {
		super("Administracion Calidad");
		setBounds(100, 100, 450, 300);
		getContentPane().setLayout(null);
		
		String[] calidad=Calidad.getCalidades();
		
		JLabel lblNuevo = new JLabel("Agregar Calidad");
		...
		JComboBox comboBox = new JComboBox(calidad);
		...
		JLabel lblEliminarVariante = new JLabel("Eliminar Calidad");
		...
		btnCerrar.setBounds(176, 237, 89, 23);
