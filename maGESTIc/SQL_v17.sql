...
CREATE TABLE Stock (
    ...
    id_variante INT NOT NULL,
    gramaje SMALLINT NOT NULL,
    PRIMARY KEY (id_stock , id_orden_trabajo , id_solicitud_compra)
);
...
ALTER TABLE Stock ADD CONSTRAINT Refrecepcion_pedido 
    FOREIGN KEY (id_solicitud_compra)
    REFERENCES recepcion_pedido(id_solicitud_compra)
;
