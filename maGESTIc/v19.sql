...
SELECT o.nombre_trabajo, r.id_recepcion_pedido, s.cant_hojas_totales, s.cant_hojas_usadas, s.marca, s.id_calidad, s.id_formato, s.id_variante, s.gramaje, s.remanente FROM stock s, orden_trabajo o, recepcion_pedido r;
